  ...
  return (
    <footer className={styles.footer}>
        <div className={styles.footer_about}>
            <img src="/Images/golden_woods_logo_white.png" className={styles.footer_logo} alt="logo" />
        ...
        <div>
            ...
            <ul className={styles.quick_links}>
                ...
                <Link to='/comingsoon'>Properties</Link>
        ...
        <div className={styles.contact}>
            ...
            <div>
                <b>Address: </b>
                <p className={styles.address}>4P6X+GRV, Lokhra,<br /> Guwahati, Assam - 781040</p>
            </div>
