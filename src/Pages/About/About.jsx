  ...
  return (
    <>
        ...
        <div className={styles.sections_container}>
          <div className={styles.about_super_container}>
              ...
              <article className={styles.contentContainer} >
                ...
                <p className={styles.description}>At the Golden Woods Developers, 
              ...
              <div className={styles.about_image_container }>
                <img src="/static_files/home_about.jpg" alt='about image' loading='lazy' className={`${styles.section_image} ${styles.section_image_one}`} /> 
                <img src="/static_files/vision_image.JPG" alt='about image' loading='lazy' className={`${styles.section_image} `} /> 
              </div>
            </section>

            <section className={styles.about_container}>
              <div className={styles.about_img}>
                <img src="/static_files/mission_image.JPG" loading='lazy' className={styles.about_img_item} alt="about image" />
              ...
              <div className={styles.about_text}>
                <p className={styles.description}>The Golden Woods Developers is a leading and innovative real estate development firm committed to transforming landscapes and enriching communities. A part of the Golden Woods Group, we are in the business of construction for the last 20 years. 
                  ...
                  <br />
                  <p className={styles.description}>With a combined square feet area of 8.00 lakhs (approx.), 
                    ...
                    benchmark in Northeast, India for high quality and sustainable development,
                    across different price segments and asset classes. </p>
              </div>
              ...
              <div className={styles.whychooseus_content}>
                <div className={styles.whychooseus_content_card}>
                  ...
                  <div className={styles.whychooseus_content_card_desc}>
                    ...
                    <p className={styles.description}>With years of experience in the real estate industry, the Golden Woods Developers brings a wealth of knowledge to the table. Our seasoned professionals have successfully navigated diverse markets, ensuring benefit from proven expertise in every transaction</p>
                  </div>
                </div>
                <div className={styles.whychooseus_content_card}>
                <div className={styles.whychooseus_content_card_img}>
                ...
                <div className={styles.whychooseus_content_card_img}>
                  ...
                  <div className={styles.whychooseus_content_card_desc}>
                    ...
                    <p className={styles.description}>Recognising that each client is unique, we offer personalised solutions that align with your specific requirements. Whether you’re a first-time homebuyer, an investor, or a property re-seller, our services are tailored to suit your individual needs. </p>
                  </div>
                </div>
                <div className={styles.whychooseus_content_card}>
                <div className={styles.whychooseus_content_card_img}>
            ...
            <section className={styles.mission_container}>
              <div className={styles.mission_banner}>
                <img src="/static_files/umang_ghy.jpg" loading='lazy' alt="mission image" />
              </div>
              <div className={styles.mission_subcontainer}>
                <div className={styles.mission_image}>
                  <img src="/static_files/banner_image.jpg" loading='lazy' alt="mission image" />
                </div>
            ...
            <section className={styles.vission_container}>
              <div className={styles.vission_subcontainer}>
                <div className={styles.vission_image}>
                  <img src="/static_files/whychooseus.jpg" loading='lazy' className={styles.vision_image} alt="vision image" />
                  <img src="/static_files/banner_image.jpg" loading='lazy' alt="vision image" />
                </div>
